...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        db.push(`isimler_${member.id}`, ` \`${name} | ${age}\` (<@&800350460573777930>)`);
        ...
        message.channel.send(embed2.setDescription(`${member} adlı kullanıcı \`${name} | ${age}\` isminde kayıt edildi! (<@&800350460573777930>)`)
